...
void Scene::createScene() {
	...
	std::vector <vec3> roofMiddleVertices = { V11, V10, V1, V5 }; // Byt plats p� V5 och V10!!
	...
	//Det blir skuggor p� v�ggarna fr�n sf�ren, b�r inte bli s�. Shadowray = fel?? Skickas shadow rayen fr�n �gat och inte intersectionpoint??
	//Golv kolsvart, fel normaler?
	//R�d v�gg samt tak ocks� kolsvart i spegel.
	//Specular �r svart???
